...
<div class = "container">
                    <h1 class="text-center title">Cập nhật thông tin khách hàng</h1>
                    <form action="../controller/c_update_user.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            <input type="number" id="id" placeholder = "Mã khách hàng" name="id" class="form-control" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <input type="tel" id="PhoneNumber" placeholder = "Số điện thoại" name="PhoneNumber" class="form-control" required>
                        </div>
                        <div class="mb-3">
